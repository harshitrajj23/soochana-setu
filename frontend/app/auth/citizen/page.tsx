      ...
      <div className="relative z-10 w-full max-w-[420px] px-6 flex flex-col items-center">
        ...
        <div className="flex gap-8 mb-6 mt-2">
          ...
          >
            Sign In
            {authType === "signin" && (
              <motion.div layoutId="authTabUnderlineCitizens" className="absolute left-0 right-0 bottom-0 h-0.5 bg-[#D4AF37] rounded-full" />
            )}
          </button>
          <button 
          ...
          >
            ...
            <div className="w-1/2 p-7 flex flex-col gap-6">
              <form onSubmit={handleLogin} className="flex flex-col gap-5 w-full">
                ...
                <div className="flex flex-col gap-1.5 w-full relative">
                  ...
                  <input type="email" className="w-full bg-transparent border-0 border-b border-white/20 px-1 py-1.5 text-[15px] text-white placeholder-white/20 focus:outline-none focus:ring-0 focus:border-[#c0a242] transition-colors duration-300" placeholder="email@example.com" />
                </div>
            ...
            <div className="w-1/2 p-7 flex flex-col gap-5">
              <form onSubmit={handleLogin} className="flex flex-col gap-4 w-full">
                ...
                <div className="flex flex-col gap-1 w-full relative">
                  <label className="text-[10px] md:text-[11px] font-semibold text-white/40 tracking-wider uppercase ml-1">Email</label>
                  <input type="email" className="w-full bg-transparent border-0 border-b border-white/20 px-1 py-1 text-[14px] md:text-[15px] text-white placeholder-white/20 focus:outline-none focus:ring-0 focus:border-[#c0a242] transition-colors duration-300" placeholder="email@example.com" />
                </div>
